    ...
    <div class="container py-5">
        <div class="pb-5 @if(Request::segment(1) == "dashboard") display-none @endif ">
            <div class="row g-4 align-items-end">
                <div class="col-xl-8">
                    <h4 class="text-primary sub-title fw-bold wow fadeInUp" data-wow-delay="0.1s">Events</h4>
                    <h1 class="display-2 mb-0 wow fadeInUp white" data-wow-delay="0.3s">Upcoming Events</h1>
                </div>
